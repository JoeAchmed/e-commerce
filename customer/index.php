...
<body>
  <div class="page-wrapper">
    ...
    <main class="main">
      <div class="page-header text-center" style="background-image: url('assets/images/backgrounds/bg-1.jpg')">
        <div class="container">
          <h1 class="page-title text-white">Welcome to Molla Shop</h1>
        </div><!-- End .container -->
      </div><!-- End .page-header -->
          ...
          <div class="row">
                  ...
                  <div class="collapse show" id="widget-1">
                    <div class="widget-body">
                      <div class="filter-items filter-items-count">
                        <?php
                        $nomor = 1;
                        $sqlkategori = "SELECT kategori_produk.*, COUNT(produk.id) AS jumlah_produk
                FROM kategori_produk
                LEFT JOIN produk ON kategori_produk.id = produk.kategori_produk_id
            ...
            <div class="col-lg-9">
              ...
              <div class="products mb-3">
                ...
                if ($col_product == 4) {
                  require "components/product_cols_4.php";
                }
                if ($col_product == 3) {
                  require "components/product_cols_3.php";
                }
                if ($col_product == 2) {
                  require "components/product_cols_2.php";
                }
                if ($col_product == 1) {
                  require "components/product_cols_list.php";
                }
                ?>
    ...
    <div class="mobile-menu-wrapper">
      ...
      <nav class="mobile-nav">
        <ul class="mobile-menu">
          ...
          <li>
            <a href="detail.php" class="sf-with-ul">Product</a>
            <ul>
              <li><a href="detail.php">Default</a></li>
...
<script>
  // Fungsi untuk menampilkan produk yang sesuai dengan filter
  function filterProducts() {
    // Mendapatkan semua checkbox kategori
    var checkboxes = document.querySelectorAll('.custom-control-input');

    // Membuat array untuk menyimpan kategori yang dicentang
    var selectedCategories = [];

    // Memeriksa setiap checkbox
    checkboxes.forEach(function(checkbox) {
      if (checkbox.checked) {
        // Jika checkbox dicentang, tambahkan kategori ke dalam array selectedCategories
        selectedCategories.push(checkbox.id.substring(4));
      }
    });
    ...
    // Menampilkan atau menyembunyikan produk berdasarkan kategori yang dicentang
    products.forEach(function(product) {
      var productCategories = product.getAttribute('data-categories').split(',');

      // Jika ada setidaknya satu kategori yang dicentang pada produk, tampilkan produk tersebut
      if (selectedCategories.some(function(category) {
  ...
  // Menambahkan event listener pada checkbox untuk memanggil fungsi filterProducts saat ada perubahan
  var checkboxes = document.querySelectorAll('.custom-control-input');
  checkboxes.forEach(function(checkbox) {
