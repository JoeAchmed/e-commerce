...
INSERT INTO `kategori_produk` VALUES (1,'elektronik'),(2,'furniture'),(3,'makanan'),(4,'minuman'),(5,'komputer'),(6,'fashion');
...
CREATE TABLE `pesanan` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_pesanan_customer_idx` (`produk_id`),
  CONSTRAINT `fk_pesanan_customer` FOREIGN KEY (`produk_id`) REFERENCES `produk` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pesanan` VALUES (1, 'ORD001', '2015-11-04','Ahmad Waluyo','Jl. Bintara 14 Kota Bekasi','081271062214','ahmad@mail.com',1,'Bu Lulu Catering',1);
...
CREATE TABLE `produk` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `kode_UNIQUE` (`kode`),
  KEY `fk_produk_kategori_profuk1_idx` (`kategori_produk_id`),
  CONSTRAINT `fk_produk_kategori_produk` FOREIGN KEY (`kategori_produk_id`) REFERENCES `kategori_produk` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `produk` VALUES (1,'TV01','dist/img/prod-1.jpg','Televisi 21 inch',3500000,5040000,5,2,'Stok Tersedia',1);
