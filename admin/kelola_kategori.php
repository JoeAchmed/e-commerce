    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        ...
        <section class="content">
          <!-- Modal -->
          <?php
          require_once "./components/kategori/form_kategori.php";
          require_once "./components/kategori/detail_kategori.php";
          ?>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <p>Data kategori yang dihapus tidak dapat dikembalikan lagi. Anda yakin akan menghapus kategori <span id="product-delete-name"></span> ?</p>
                </div>
    ...
    <script>
      ...
      $(function() {
        ...
        if (success) {
          Toast.fire({
            icon: 'success',
            title: `Sukses ${success === "create" ? "Tambah" : success === "update" ? "Ubah" : "Hapus"} Kategori`,
            text: `Horee... Kategori sukses ${success === "create" ? "ditambahkan" : success === "update" ? "diubah" : "dihapus"} !`
          });
      ...
      function handleGetNameProduct(payload) {
        try {
          ...
          document.getElementById("iddel").href = "controller/kategori/hapus_kategori.php?iddel=" + id;
        } catch (error) {
          console.log(error);
        }
      }
